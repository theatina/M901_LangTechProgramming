    ...
    def read_folder(self):
        ...
        for sub_d_path, d_names, files_d in os.walk(self.source_folder):
            ...
            for f_name in files_d:
                ...
                # if no exception was raised, the following are performed
                    ...
                    # In case of an error related to the file frequency dictionary, and unhandled exception is raised, to provoke the programme's exit, as there is no way to overcome this problem without rerunning it
                    if token_freq=={}:
